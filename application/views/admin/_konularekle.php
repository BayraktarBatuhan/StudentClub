...
<section id="main-content">
	...
	<section class="wrapper">
		<!-- //market-->
		<form Id="urunler_ekle" action="<?=base_url()?>/admin/konular/eklekaydet" method="post">
        ...
        <thead>
          ...
          <tr>
            <th data-breakpoints="xs"><label style="color:#4f4f4f" for="exampleInputEmail1">Başlık</label></th>
