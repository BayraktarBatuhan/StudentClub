...
<section id="main-content">
	...
	<section class="wrapper">
		<!-- //market-->
		<form Id="kullanici_ekle" action="<?=base_url()?>/admin/kulupler/eklekaydet" method="post">
        ...
        <thead>
          ...
          <tr>
            <th data-breakpoints="xs"><label for="exampleInputEmail1">Kulüp Adı</label></th>
		  ...
		  <tr>
            <th data-breakpoints="xs"><label for="exampleInputEmail1">Kayıt Tablosu</label></th>
		  ...
		  <tr>
            <th data-breakpoints="xs"><label for="exampleInputEmail1">Aday Tablosu</label></th>
            <th><input type="text" class="form-control" id="tablo_aday" name="tablo_aday" placeholder="Enter email"></th>
            <th></th>
			<th></th>
		  ...
		  <tr>
            <th data-breakpoints="xs"><label for="exampleInputEmail1">Başkanlık Tablosu</label></th>
            <th><input type="text" class="form-control" id="tablo_baskan" name="tablo_baskan" placeholder="Enter email"></th>
            <th></th>
			<th></th>
