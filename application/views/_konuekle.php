		...
		<form Id="urunler_ekle" action="<?=base_url()?>/home/konueklekaydet" method="post">
 ...
 <tr>
		   ...
		   <tr>
            <th data-breakpoints="xs"><label style="color:#4f4f4f" for="exampleInputEmail1">Explenation</label></th>
