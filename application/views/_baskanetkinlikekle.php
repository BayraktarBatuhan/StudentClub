		...
		<form Id="urunler_ekle" action="<?=base_url()?>home/etkinlikeklekaydet" method="post">
        ...
        <thead>
		  ...
		  <tr>
            <th data-breakpoints="xs"><label style="color:#4f4f4f" for="exampleInputEmail1">Record Table</label></th>
 ...
 <tr>
       ...
       <script src="<?=base_url()?>ckeditor/ckeditor.js"></script>
		  ...
		  <button type="submit" style="background-color:#ee30a7" class="btn btn-success pull-right">Save</button>
		 </th></tr>
