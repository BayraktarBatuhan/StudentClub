                      ...
                      <?php
						...
						?>
				            ...
				            <div class="form-group col-md-6">
				                <input type="text" name="adsoy" class="form-control" required="required" placeholder="Name Surname">
				            </div>
				            <div class="form-group col-md-6">
				            ...
				            <div class="form-group col-md-12">
				                <textarea name="mesaj" id="mesaj" required="required" class="form-control" rows="8" placeholder="Your Messages"></textarea>
				            </div>                        
				            <div class="form-group col-md-12">
