      ...
      <table class="table" ui-jq="footable" ui-options='{
		...
		?>
		  ...
		  <th scope ="row"><?=$rs->Id?></th>
			...
			<td><a href="<?=base_url()?>admin/baskanlar/adaylar/<?=$rs->Id?>/<?=$id?>" data-toggle="modal" class="btn btn-success">
                                    Candidates
                                </a></td>
								
								<td><a href="<?=base_url()?>admin/baskanlar/sonuclar/<?=$rs->Id?>" data-toggle="modal" class="btn btn-success">
                                    Look Voting
                                </a></td>
			
			
			<td><a href="<?=base_url()?>admin/kulupler/duzenle/<?=$rs->Id?>" data-toggle="modal" class="btn btn-success">
                                    Edit
                                </a></td>
