		...
		<thead>
          ...
          <h4 class="title">Image Save</h4>   
						...
						*Imagers type may (gif|jpg|png) 
						maximum resolution 1024*1024<br> size :be less 1000kb 
	   ...
	   <form role="form" id="urun_resim_ekle" enctype="multipart/form-data" action="<?=base_url()?>home/resim_kaydet/<?=$id?>" method="post" >
 
	    		 <button  type="submit" style="background-color:#ee30a7"  class="btn btn-primary btn-round pull-left">Images Save</button>
